...
public class AdminController {
    ...
    @GetMapping("admin/allOrders/{orderId}/update-status")
    public String updateOrderStatus(@PathVariable("orderId") int orderId, @RequestParam("status") Status status) {
        orderRepository.updateOrderStatus(orderId, status);
        return "redirect:/admin/allOrders";

    }

    @GetMapping("/admin/allOrders/search")
    public String searchOrders(@RequestParam("orderNumber") String orderNumber, Model model) {
        List<Order> foundOrders = orderRepository.findByLastFourChars(orderNumber);
        if (!foundOrders.isEmpty()) {
            model.addAttribute("foundOrders", foundOrders);
            return "/product/foundOrder";
        }
        return "/product/orderNotFound";
    }
